<!-- モーダル グーグルブックの登録フォーム -->
<div class="modal fade" id="{{ 'a-'.$item->Item->isbn }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-book__header">
                ...
                <div class="modal-book__details">
                    <!-- 書籍タイトル -->
                    <p class="modal-book__title">書籍名：{{ $item->Item->title}}</p>
            ...
            <!-- 登録フォーム -->
            <form action="{{ route('search.store',['book_id'=>$item->Item->isbn]) }}" method="POST">
                @csrf
